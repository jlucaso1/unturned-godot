...
public class SourceTextAssertions
{
    ...
    {
        string path = FindRepositoryFile(Path.Combine("src", "Net", "NetworkManager.cs"));
    ...
    {
        string ownerPath = FindRepositoryFile(Path.Combine("src", "World", "InstancedStaticBodies.cs"));
        string builderPath = FindRepositoryFile(Path.Combine("src", "World", "ObjectsBuilder.cs"));
        string netPath = FindRepositoryFile(Path.Combine("src", "Net", "NetworkManager.cs"));
        string owner = File.ReadAllText(ownerPath);
        string builder = File.ReadAllText(builderPath);
