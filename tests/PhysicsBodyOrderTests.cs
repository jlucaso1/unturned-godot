...
public class PhysicsBodyOrderTests
{
    ...
    public void LegacyObjectIdsAreNormalizedBeforeEveryGuidKeyedWorldBuild()
    {
        ...
        Assert.Contains("LegacyPlacements.ResolveGuids(objects, db)", plan);
        Assert.Contains("LegacyPlacements.AppendTrees(trees, objects, db)", plan);
        ...
        // And nothing else derives one. A second ResolvePlacementGuids call site is a fifth copy of the
